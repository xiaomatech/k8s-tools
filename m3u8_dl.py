...
class Downloader:
    def __init__(self, pool_size=100, retry=3):
...
if __name__ == '__main__':
    downloader = Downloader(200)
    downloader.run('https://yunqivod.xiaozhizuo.tv/clip/0x0/5960639efe2a85829f31d1405bb12fd2/5960639efe2a85829f31d1405bb12fd2.m3u8', '/tmp/video/')
